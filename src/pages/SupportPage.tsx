      ...
      <section className="wevo-section pt-32 scroll-mt-20" style={{ backgroundColor: "#e1f2fa4d" }}>
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <a href="mailto:connect@wevowater.com" className="inline-flex items-center justify-center px-10 py-4 text-sm uppercase tracking-[0.15em] font-medium border border-foreground bg-foreground text-background hover:bg-background hover:text-foreground transition-all duration-500">
            Contact Us
          </a>
          </motion.div>
        </div>
